        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="relative h-full min-h-[400px] rounded-3xl overflow-hidden shadow-2xl group border border-white/10">
              <Image 
                src="/residential/a_modern_luxury_individual_villa_in_india.jpeg" 
                alt="Residential Construction Quality" 
                fill 
              ...
              {/* Glass Stat Card */}
              {/* Small Red Badge */}
              <div className="absolute bottom-6 right-6 bg-primary p-5 rounded-xl shadow-lg border border-white/10 max-w-[220px]">
                <div className="font-heading text-4xl font-bold mb-1 text-white">200+</div>
                <div className="text-xs font-semibold tracking-wide text-white/90 uppercase leading-relaxed">Families Living in <br/>Our Built Homes</div>
              </div>
            </div>
            ...
            <div className="lg:py-8 flex flex-col justify-center">
              ...
              <h2 className="font-heading text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                Building Homes with <span className="text-primary">Trust & Transparency</span>
              </h2>
              <p className="text-white/70 mb-10 text-lg leading-relaxed">
                Building a home is a once-in-a-lifetime journey. We make it stress-free with guaranteed pricing, clear communication, and quality that lasts for generations.
              </p>
        ...
        <div className="container-custom">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="font-heading text-4xl lg:text-5xl font-bold text-white mb-6">
              How We Build Your Home - <span className="text-primary">Step by Step</span>
            </h2>
            <p className="text-white/60 text-lg">
              A transparent, systematic approach to turning your dream home into reality.
            </p>
          </div>
