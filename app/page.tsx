...
const services = [
  ...
  { title: "2D Design", description: "Detailed 2D floor plans and layouts that help you visualize space utilization.", icon: PenTool, href: "/services/interior-design/2d-design", image: "https://images.unsplash.com/photo-1503387762-592deb58ef4e?q=80&w=831" },
  { title: "3D Design", description: "Realistic 3D renderings and visualizations of your interior spaces.", icon: Box, href: "/services/interior-design/3d-design", image: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=800" },
