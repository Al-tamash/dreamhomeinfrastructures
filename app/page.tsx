...
const services = [
  { title: "Residential Construction", description: "Transform your dream home into reality with our expert residential construction services.", icon: Home, href: "/services/building-construction" },
  { title: "Commercial Construction", description: "Professional commercial building solutions for offices, retail spaces, and industrial facilities.", icon: Building2, href: "/services/building-construction" },
  { title: "Villa & Farm House", description: "Luxurious villa and farmhouse construction with premium materials and contemporary designs.", icon: Building, href: "/services/building-construction" },
  { title: "2D Design", description: "Detailed 2D floor plans and layouts that help you visualize space utilization.", icon: PenTool, href: "/services/interior-design" },
  { title: "3D Design", description: "Realistic 3D renderings and visualizations of your interior spaces.", icon: Box, href: "/services/interior-design" },
  { title: "3D Walkthrough", description: "Immersive virtual tours of your future space with cutting-edge technology.", icon: Video, href: "/services/interior-design" },
];
